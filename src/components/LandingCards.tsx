...
export default component$(() => {
  ...
  const showMusicLinks = useSignal(false);
  const i18n = useI18n();
                  ...
                  <div class="bg-stone-50 lg:bg-white rounded-xl overflow-hidden lg:border lg:border-stone-200 lg:shadow-lg">
                    ...
                    <div class="p-5 md:p-8 lg:p-5">
                      ...
                      {(service as any).contentType === 'myMusic' ? (
                        ...
                        <>
                          {/* Show music links or artist profile content */}
                          {showMusicLinks.value ? (
                            <>
                              {/* Back button */}
                              <button
                                onClick$={() => { showMusicLinks.value = false; }}
                                class="inline-flex items-center gap-2 text-stone-600 hover:text-stone-800 mb-4 transition-colors"
                              >
                            ...
                            <>
                              ...
                              {/* CTA - Opens My Music streaming links inline */}
                              <button
                                onClick$={() => {
                                  expandedGalleryItem.value = null;
                                  showMusicLinks.value = true;
                                }}
