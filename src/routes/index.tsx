      ...
      <div>
        ...
        <section class="relative py-16 px-5 overflow-hidden bg-stone-100">
          <div class="relative max-w-xl mx-auto">
            {/* Outer container with textured border */}
            <div
              class="relative bg-gradient-to-r from-stone-100 to-stone-50 rounded-2xl p-3 border-2 border-stone-300/60 shadow-lg"
              style={{
            ...
            >
              {/* Inner content card */}
              <div class="relative bg-stone-50 rounded-xl p-8">
